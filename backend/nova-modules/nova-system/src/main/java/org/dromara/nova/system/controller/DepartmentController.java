...
/**
 * Department TreeTable 后端接口。
 */
@Tag(name = "Department 管理", description = "维护当前 Tenant 的 Department 树、状态和层级关系。")
@RestController
...
public class DepartmentController {
    ...
    @Operation(summary = "查询 Department TreeTable", description = "查询 Department TreeTable。接口按当前登录用户、PLATFORM/TENANT Context、权限和 DataScope 执行服务端校验。")
    ...
    @GetMapping("/tree")
    @SaCheckPermission("system:department:list")
    @Operation(summary = "查询 Department 选择树", description = "查询 Department 选择树。接口按当前登录用户、PLATFORM/TENANT Context、权限和 DataScope 执行服务端校验。")
    ...
    @GetMapping("/{id}")
    @SaCheckPermission("system:department:list")
    @Operation(summary = "查询 Department 详情", description = "查询 Department 详情。接口按当前登录用户、PLATFORM/TENANT Context、权限和 DataScope 执行服务端校验。")
    ...
    @SaCheckPermission("system:department:update")
    @Operation(summary = "修改 Department 状态", description = "修改 Department 状态。接口按当前登录用户、PLATFORM/TENANT Context、权限和 DataScope 执行服务端校验。")
