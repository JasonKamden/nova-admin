...
VALUES (1, 'DIRECTORY', NULL, '系统管理', 'system', '/system', NULL, NULL, 'carbon:settings', 'route.system', 10, 1, 1,
        0, 1, NOW(), 1, NOW(), 0, 0),
       (5, 'MENU', NULL, 'Tenant 管理', 'platform_tenant', '/platform/tenant', 'view.platform_tenant', 'platform:tenant:list',
       ...
       (6, 'BUTTON', 5, '新增Tenant', NULL, NULL, NULL, 'platform:tenant:add', NULL, NULL, 1, 1, 0, 0, 1, NOW(), 1,
        NOW(), 0, 0),
       (7, 'BUTTON', 5, '查看Tenant详情', NULL, NULL, NULL, 'platform:tenant:detail', NULL, NULL, 2, 1, 0, 0, 1, NOW(), 1,
        NOW(), 0, 0),
