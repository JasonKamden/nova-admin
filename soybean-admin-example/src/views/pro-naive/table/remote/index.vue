...
<template>
  <ConfigProvider>
    <div class="h-full flex flex-col">
      <ProCard :show-collapse="false" :title="$t('page.proNaive.table.remote.filterCondition')" class="mb-24px">
        <ProSearchForm :columns="searchColumns" :form="searchForm" label-placement="left" v-bind="proSearchFormProps"/>
      </ProCard>
      <ProDataTable
          :columns="columns"
