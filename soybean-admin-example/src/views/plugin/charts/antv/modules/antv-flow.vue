...
<template>
  <div class="relative">
    ...
    <div class="absolute left-0 right-0 z-1 flex items-center items-stretch justify-between">
      <NButtonGroup class="bg-white!" size="small">
      ...
      <div class="flex-center gap-12px">
        <NPopover :animated="false" placement="bottom-end">
          <template #trigger>
            <NButton class="bg-white!" size="small">
              <icon-fe-question/>
            </NButton>
          </template>
          <div class="flex-col gap-8px">
            <div class="text-12px font-bold" span="2">节点图例</div>
