...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    <NCard :bordered="false" class="card-wrapper sm:flex-1-hidden" size="small" title="Excel导出">
      <template #header-extra>
        <NSpace align="end" class="lt-sm:w-200px" justify="end" wrap>
          <NButton ghost size="small" type="primary" @click="exportExcel">
            <template #icon>
