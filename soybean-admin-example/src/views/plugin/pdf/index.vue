...
<template>
  <div class="overflow-hidden">
    <NCard :bordered="false" class="h-full card-wrapper" content-class="overflow-hidden" title="PDF 预览">
      <div class="h-full flex-col-stretch">
        ...
        <NScrollbar class="flex-1-hidden">
          <NSkeleton v-if="loading" :repeat="12" class="mt-12px" size="small" text/>
          <VuePdfEmbed
              ref="pdfRef"
              :class="{ 'h-0': loading }"
              :page="currentPage"
