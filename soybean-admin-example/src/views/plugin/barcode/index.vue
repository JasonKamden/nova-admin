...
<template>
  <div class="overflow-hidden">
    <NCard :bordered="false" class="h-full card-wrapper" content-class="overflow-hidden" title="条形码">
      <NScrollbar class="h-full">
        <NGrid :x-gap="12" :y-gap="24" cols="1 s:2 l:3" item-responsive responsive="screen">
