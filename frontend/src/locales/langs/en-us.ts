const local: App.I18n.Schema = {
    ...
    page: {
        ...
        user: {
            ...
            importGuideDesc: 'Download the template first, then upload the completed Excel file.',
            importTemplate: 'Download Import Template',
            importAccept: 'Only .xls / .xlsx files are supported',
            downloadTemplate: 'Download Template',
            importFile: 'Upload Import File',
            importEmptyFile: 'No file selected',
            selectImportFile: 'Select File',
            startImport: 'Start Import',
            importSelectFile: 'Please select an import file first',
        ...
        dictionary: {
            ...
            collapseTypePanel: 'Collapse Dictionary Types',
            expandTypePanel: 'Expand Dictionary Types',
            selectTypeTip: 'Select a dictionary type on the left to view dictionary data.',
            form: {
        ...
        message: {
            ...
            attachmentHint: 'Upload Message Attachments',
            attachmentHintDesc: 'Attachments are uploaded to the file service first and then linked by fileIds.',
            ...
            expectedRecipients: 'Expected to send to {count} users',
            editorPlaceholder: 'Enter message content. Headings, lists, links, and tables are supported.',
        ...
        monitor: {
            ...
            contentTruncatedTip: 'The content is long. Expand to view the full payload.',
            operator: 'Operator',
