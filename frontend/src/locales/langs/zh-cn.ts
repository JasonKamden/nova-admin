const local: App.I18n.Schema = {
    ...
    page: {
        ...
        home: {
            ...
            tenantDesc: '当前为 {tenantName} 上下文，首页展示真实租户聚合数据。',
            currentSpace: '当前空间',
            ...
            tenantCount: '租户总数',
            enabledTenantCount: '启用租户',
            disabledTenantCount: '停用租户',
        ...
        tenant: {
            ...
            statusConfirm: '确认{action}租户“{name}”吗？',
            deleteConfirm: '确认删除租户“{name}”吗？',
            form: {
                tenantCode: '请输入租户编码',
                tenantName: '请输入租户名称',
        ...
        user: {
            ...
            importTitle: '用户导入',
            importGuide: '导入说明',
            importGuideDesc: '请先下载模板，按模板格式填写后再上传 Excel 文件。',
            importTemplate: '下载导入模板',
            importAccept: '仅支持 .xls / .xlsx 文件',
            downloadTemplate: '下载模板',
            importFile: '上传导入文件',
            importEmptyFile: '尚未选择文件',
            selectImportFile: '选择文件',
            startImport: '开始导入',
            importSelectFile: '请先选择导入文件',
            importSuccess: '成功导入 {count} 条',
            importTotal: '总数',
            importSucceeded: '成功',
            importFailed: '失败',
            importErrorDetail: '错误明细',
            resetPassword: '重置密码',
            roleSetting: '分配角色',
            addTitle: '新增用户',
            editTitle: '编辑用户',
        ...
        menu: {
            ...
            platformOnlyTip: '租户上下文只读，切换到平台后可维护菜单',
            form: {
                menuType: '请选择菜单类型',
                menuName: '请输入菜单名称'
            },
        ...
        dictionary: {
            ...
            collapseTypePanel: '收起字典类型',
            expandTypePanel: '展开字典类型',
            selectTypeTip: '请选择左侧字典类型后查看字典数据',
            form: {
                dictName: '请输入字典名称',
                dictCode: '请输入字典编码',
                dictLabel: '请输入字典标签',
        ...
        message: {
            ...
            contentHtml: '消息正文',
            attachments: '附件',
            attachmentHint: '上传消息附件',
            attachmentHintDesc: '附件会先上传到文件服务，再按 fileIds 关联到当前消息。',
            recipientRule: '接收规则',
            includeChildren: '包含下级部门',
            departments: '部门',
            roles: '角色',
            users: '用户',
            ...
            confirmSend: '确认发送',
            expectedRecipients: '预计发送给 {count} 位用户',
            editorPlaceholder: '请输入消息正文，可使用标题、列表、链接和表格。',
        ...
        monitor: {
            ...
            contentTruncatedTip: '内容较长，当前为折叠预览，可展开查看完整内容。',
            operator: '操作人',
            requestMethod: '请求方法',
            requestUri: '请求地址',
            requestIp: '请求 IP',
