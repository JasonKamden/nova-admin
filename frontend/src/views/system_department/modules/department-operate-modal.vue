...
import {fetchCreateDepartment, fetchDepartmentDetail, fetchDepartmentSelector, fetchUpdateDepartment, fetchUserPage} from '@/service/api';
...
<template>
  <NModal v-model:show="visible" :mask-closable="false" class="w-720px" preset="card">
    <template #header>
