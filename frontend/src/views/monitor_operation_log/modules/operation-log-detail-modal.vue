...
<template>
  <NModal v-model:show="visible" preset="card" class="w-980px" :mask-closable="false">
    <template #header><div class="text-16px font-600">{{ $t('page.monitor.detailTitle') }}</div></template>
    <NSpin :show="loading">
