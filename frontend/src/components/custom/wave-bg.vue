      ...
      <svg height="1337" width="1337">
        <defs>
          ...
          <linearGradient id="linearGradient-2" x1="0.79" x2="0.21" y1="0.62" y2="0.86">
            <stop :stop-color="lightColor" offset="0" stop-opacity="1"/>
            <stop :stop-color="darkColor" offset="1" stop-opacity="1"/>
          </linearGradient>
        </defs>
        <g opacity="1">
      ...
      <svg height="896" width="967.8852157128662">
        <defs>
          ...
          <linearGradient id="linearGradient-3" x1="0.5" x2="0.5" y1="0" y2="1">
            <stop :stop-color="darkColor" offset="0" stop-opacity="1"/>
            <stop :stop-color="lightColor" offset="1" stop-opacity="1"/>
          </linearGradient>
        </defs>
        <g opacity="1">
